...
<html>
    ...
    @section("hero_courses")

    @show

    @section("course_courses")

    @show

    @section("register_courses")

    @show

    <!--teacher starts here-->

    @section("hero_teacher")
