                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{url('/add_student')}}">Add Student</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{url('/view_student')}}">View Student</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href="{{url('/add_teacher')}}">Add Teacher</a></li>
                            <li><i class="menu-icon ti-themify-logo"></i><a href="{{url('/view_teacher')}}">View Teacher</a></li>
                        </ul>
                    </li>
